...
Base.prototype.attr = function (attr,value) {
	for (var i = 0; i < this.elements.length; i ++) {
		if(arguments.length ==1){	//传1个值进来就代表获取属性
			return this.elements[0].getAttribute(attr); //getAttribute能获取到自定义属性
		}else if(arguments.length ==2){	//传1个值进来就代表修改属性
...
Base.prototype.index = function () {
	var children = this.elements[0].parentNode.children;		//传进来的节点的父节点,的所有子节点
